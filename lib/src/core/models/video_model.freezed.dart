...
class _$VideoModelImpl implements _VideoModel {
  ...
  @override
  String toString() {
    return 'VideoModel(id: $id, videoUrl: $videoUrl, thumbnailUrl: $thumbnailUrl, description: $description, userId: $userId, username: $username, likes: $likes, isLiked: $isLiked, isSaved: $isSaved)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, videoUrl, thumbnailUrl,
      description, userId, username, likes, isLiked, isSaved);
...
abstract class _VideoModel implements VideoModel {
  const factory _VideoModel(
      ...
      final int likes,
      final bool isLiked,
      final bool isSaved}) = _$VideoModelImpl;
